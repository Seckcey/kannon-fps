...
This document describes the current source. The Sunbreak V2 visual and active-practice implementation shipped in verified release [`bd58bd3`](https://github.com/Seckcey/kannon-fps/commit/bd58bd35723f8f7b9bb10b58914784b26909533e) through [PR #3](https://github.com/Seckcey/kannon-fps/pull/3). The later art and animation changes described below belong to the [art-depth candidate](ART_DEPTH.md), which is pending release. The [/health](https://kpop.8westventures.com/health) response is the canonical current deployed build identity; later documentation closeouts can advance its revision. See the [release record](RELEASE.md) for historical CI, deployment and acceptance evidence. Physical-phone performance and two-household play remain separate acceptance gates.
