...
3. **User routing step:** point `kpop.8westventures.com` in the existing Cloudflare Tunnel to HTTP `127.0.0.1:14350`, then verify public HTTPS/WSS and private invitations on that address.
