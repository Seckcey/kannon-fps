...
The V3 scout export contains **22,486 vertices and 20,922 triangles in 2,720,096 bytes**. Its SHA-256 is `7e0b589e779c403dbbe61a5522fcbc4503de99815a6782b18b355cbecfe1091e`. Four body material batches and three active AR batches use shared geometry/materials with separate player skeletons. Eight visible AR scouts therefore use 56 character draws, excluding arena geometry, shadows and postprocessing. See the [export report](../art/source/scout-export-review.json) for the binary counts and the [source notes](../art/source/README.md) for rebuild instructions.
