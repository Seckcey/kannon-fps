...
The scout motion and platform practice upgrade is live at **https://kpop.8westventures.com** on Coastline. Implementation **[`bbc40d3`](https://github.com/Seckcey/kannon-fps/commit/bbc40d344e62250dd88d75d7208c6570d66dcf57)** merged through [PR #6](https://github.com/Seckcey/kannon-fps/pull/6) with [successful main CI](https://github.com/Seckcey/kannon-fps/actions/runs/34224016799). [/health](https://kpop.8westventures.com/health) reports the canonical current deployed build, including later documentation closeouts. Cloudflare Tunnel uses **HTTP `127.0.0.1:14350`**. All 133 tests, asset/type/build checks, desktop/touch input, isolated eight-player Linux traffic and [public rendered practice](docs/verification/scout-motion-live.json) passed. Real-device controls/performance and a two-household match remain; use the [family playtest guide](docs/FAMILY_PLAYTEST.md). The [release record](docs/RELEASE.md) separates current evidence from earlier art and practice releases.

## Sunbreak V3 art and motion

The latest [scout motion upgrade](docs/SCOUT_MOTION_POLISH.md) gives the Blender character fitted shoulder armor and a more continuous upper-back silhouette. Gait follows visible travel around walls and through remote-player interpolation, and reload/heal prediction follows confirmed server movement restrictions. Practice rivals can pursue visible opponents up the existing south stairs and return through them. The fixed loadout, authoritative movement, collision and scoring are preserved.
