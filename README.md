...
The combat feedback upgrade is live at **https://kpop.8westventures.com** on Coastline. Implementation **[`5fc2c94`](https://github.com/Seckcey/kannon-fps/commit/5fc2c9472df97ffb81658a6d949b27bb60484f2a)** merged through [PR #5](https://github.com/Seckcey/kannon-fps/pull/5) with [successful main CI](https://github.com/Seckcey/kannon-fps/actions/runs/34217145510). [/health](https://kpop.8westventures.com/health) reports the canonical current deployed build, including later documentation closeouts. Cloudflare Tunnel uses **HTTP `127.0.0.1:14350`**. All 108 tests, asset/type/build checks, desktop/touch input, isolated eight-player Linux traffic and public rendered practice passed. Real-device controls/performance and a two-household match remain; use the [family playtest guide](docs/FAMILY_PLAYTEST.md). The [release record](docs/RELEASE.md) separates current evidence from earlier art and practice releases.

## Sunbreak V3 art and motion

The deployed [combat feedback](docs/COMBAT_FEEDBACK.md) adds per-pellet impacts, restrained shield/armor reactions and correctly placed respawn effects. Fixed-capacity render batches keep sustained firing bounded. The V3 Blender models, movement, weapons and scoring remain unchanged.
