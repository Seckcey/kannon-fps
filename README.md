...
This is an early playable build. Internet hosting, real-device performance/controls acceptance, and a two-household playtest remain release gates. The Blender art uses human proportions with stylized armor; it is not photorealistic or motion-captured.
